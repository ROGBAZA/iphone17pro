        ...
        <section className="bg-black py-20 px-6" id="design">
            <div className="max-w-7xl mx-auto text-center">
                <div className="text-center mb-16">
                    <h2 className="text-5xl font-bold mb-6">Design Revolucionário</h2>
                    <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-3xl mx-auto">Descubra as características inovadoras que tornam o iPhone 17 Pro o smartphone mais avançado do mundo.</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-8 mb-16">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        ...
                        <p className="text-gray-300">
                            Acabamentos em quatro cores elegantes: Grafite, Prata, Ouro e Azul Sierra.
                        </p>
                    </div>
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-5" src="/img/ios-features.jpg" alt="ios-features" />
                        <h3 className="font-bold mb-2 text-3xl">IOS 26</h3>

                        <p className="text-gray-300">O iOS 26 trás novas funcionalidades e melhorias de desempenho para uma experiência ainda mais fluida, sistema operacional mais avançado do mundo com IA integrada.</p>
                    </div>
                </div>
            </div>
            ...
            <div id="camera" className="text-center">
                ...
                <div className="grid grid-cols-3 gap-2 md:gap-6 mb-16">
                    <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 cursor-pointer transition-all duration-300">
                        <div className="text-2xl font-bold text-blue-600 mb-4">48MP</div>
                        <h4 className="text-xl font-semibold mb-2">Principal</h4>
                        <p className="text-gray-400"> Sensor quad-pixel com foco automático</p>
                    </div>
                    <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 cursor-pointer transition-all duration-300">
                        <div className="text-2xl font-bold text-orange-500 mb-4">12MP</div>
                        <h4 className="text-xl font-semibold mb-2">Ultra Wide</h4>
                        <p className="text-gray-400">Campo de visão de 120° para fotos amplas</p>
                    </div>
                    <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 cursor-pointer transition-all duration-300">
                        <div className="text-2xl font-bold text-blue-600 mb-4">12MP</div>
                        <h4 className="text-xl font-semibold mb-2">Telefoto 5x</h4>
                        <p className="text-gray-400">Zoom óptico de até 5x para detalhes distantes</p>
                    </div>
                </div>
